...
(function () {
  ...
  var css = [
    ...
    '.tour-box .row{display:flex;align-items:center;justify-content:space-between;gap:12px}',
    ...
    '.tour-box .acts{display:flex;gap:7px}',
    ...
    '.tour-box .quit{position:absolute;top:9px;right:10px;padding:3px 7px;font-size:.72rem;',
      'border:none;color:var(--panel-muted,#949ba1);background:none}',
  ...
  function build() {
    ...
    box.innerHTML =
      '<button class="quit" type="button" aria-label="Close walkthrough">Esc ✕</button>' +
      '<p></p><div class="row"><span class="count"></span>' +
      '<span class="acts"><button type="button" class="bk">Back</button>' +
